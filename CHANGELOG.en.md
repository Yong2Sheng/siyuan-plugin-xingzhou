...
- Made Today's Intake an independently scrollable region with a persistent header and a tighter height cap in tablet single-column layouts, preventing long entry lists from stretching the entire page.
